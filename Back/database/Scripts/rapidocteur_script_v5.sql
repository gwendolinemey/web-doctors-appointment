...
CREATE TABLE public."Praticien"(
	...
	image text,
	"dureeRdvMinutes" numeric,
	"semainesProposees" numeric,
...
-- ddl-end --
-- object: public."Creneau" | type: TABLE --
-- DROP TABLE public."Creneau";
CREATE TABLE public."Creneau"(
	"idCreneau" serial,
	"debutHeures" numeric NOT NULL,
	"debutMinutes" numeric NOT NULL,
	"finHeures" numeric NOT NULL,
	"finMinutes" numeric NOT NULL,
	"idJour_Jour" integer NOT NULL,
	"idPraticien_Praticien" integer NOT NULL,
	CONSTRAINT pk_creneau PRIMARY KEY ("idCreneau")

);
-- ddl-end --
-- object: "Jour_fk" | type: CONSTRAINT --
-- ALTER TABLE public."Creneau" DROP CONSTRAINT "Jour_fk";
ALTER TABLE public."Creneau" ADD CONSTRAINT "Jour_fk" FOREIGN KEY ("idJour_Jour")
REFERENCES public."Jour" ("idJour") MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --


-- object: "Praticien_fk" | type: CONSTRAINT --
-- ALTER TABLE public."Creneau" DROP CONSTRAINT "Praticien_fk";
ALTER TABLE public."Creneau" ADD CONSTRAINT "Praticien_fk" FOREIGN KEY ("idPraticien_Praticien")
REFERENCES public."Praticien" ("idPraticien") MATCH FULL
ON DELETE CASCADE ON UPDATE CASCADE;
-- ddl-end --
